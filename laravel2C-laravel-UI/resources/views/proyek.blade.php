  ...
  {{-- header --}}
    ...
    <br>
          ...
          <div class="bg-light border rounded-3">
            <span class="fs-4">PROYEK</span> <br><br>
            
            <div class="card">
              <div class="card-header">
                <a href="{{ ('tambah-proyek') }}" class="btn btn-success">+ Tambah</a>
              </div>
              <div class="card-body">
                <label for="">Status</label>
                <select class="form-select" aria-label="Default select example">
                  <option selected>Pilih satus</option>
              ...
              <div class="card-body">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row">1</th>
                        <td>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptatem doloribus molestias repellendus expedita ut suscipit voluptates numquam quam, vero quia quibusdam, dolor fuga delectus aperiam incidunt enim fugit, eligendi nostrum.</td>
                        <td>1 juli 2020 <br> 08.00</td>
                        <td>admin</td>
                        <td>Publish</td>
                        <td>edit | delete</td>
