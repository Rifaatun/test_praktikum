  ...
  <header class="mb-auto">
    <div><div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <nav class="nav nav-masthead justify-content-center float-md-end">
        <a class="nav-link fw-bold py-1 px-0" href="{{ ('utama') }}">Home</a>
        <a class="nav-link fw-bold py-1 px-0" href="{{ ('about') }}">About</a>
        <a class="nav-link fw-bold py-1 px-0 active" aria-current="page" href="{{ ('contact') }}">Contact</a>
      </nav>
    </div>
  </header>

  <main class="px-3">
    <h1>Welcome In Our Media Social:</h1>
    <p class="lead">+62 822 9938 4563</p>
    <p class="lead">udon@gmail.com</p>
    <p class="lead">Jl. Rajawali Jakarta Selatan, Jakarta, Indonesia </p>
