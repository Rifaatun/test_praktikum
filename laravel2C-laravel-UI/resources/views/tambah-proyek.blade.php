  ...
  {{-- header --}}
    ...
    <br>
          ...
          <div class="bg-light border rounded-3">
            <span class="fs-4">TAMBAH PROYEK</span> <br><br>

            <form class="row g-3">
              <div class="col-6">
                <label for="inputAddress" class="form-label">Judul</label>
                <input type="text" class="form-control" id="inputAddress" placeholder="judul proyek">
              </div>
              <div class="col-md-12">
                <label for="inputCity" class="form-label">Deskripsi</label>
                <textarea type="text" class="form-control" id="Deskripsi" style="height: 100px" placeholder="Deskripsi Singkat"></textarea>
              </div>
              <div class="col-md-6">
                <label for="inputState" class="form-label">Kategori</label>
                <select id="inputState" class="form-select">
                  <option selected>Publish</option>
                  <option selected>UnPublish</option>
                </select>
              </div>
             <div class="col-md-6">
